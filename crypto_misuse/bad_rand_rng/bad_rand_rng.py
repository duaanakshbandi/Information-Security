...
# enter your code here
    # Unpack IV
    unpacked = struct.unpack('<I', iv[12:16])[0]
    # Insert IV into known rand function and get the 1st part of the key
    next = ((unpacked * 1103515245) + 12345) & 0x7fffffff
    key = struct.pack('<I', next)
    # Repeat 3 more times for 3 other parts of the key
