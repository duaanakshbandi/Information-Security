...
-- -----------------------------------------------------
-- Table `INFOSEC_DB`.`user_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `INFOSEC_DB`.`user_data` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `INFOSEC_DB`.`user_data` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
GRANT SELECT,INSERT,DELETE,UPDATE ON `INFOSEC_DB`.`user_data` TO 'db_user'@'%';
