...
-- -----------------------------------------------------
-- Table `INFOSEC_DB`.`likes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `INFOSEC_DB`.`likes` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `INFOSEC_DB`.`likes` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `post_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_likes_1_idx` (`user_id` ASC),
...
GRANT SELECT,INSERT,DELETE,UPDATE ON `INFOSEC_DB`.`likes` TO 'db_user'@'%';
