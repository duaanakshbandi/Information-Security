...
-- -----------------------------------------------------
-- Table `INFOSEC_DB`.`reservation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `INFOSEC_DB`.`reservation` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `INFOSEC_DB`.`reservation` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `number` VARCHAR(64) NOT NULL,
  `guests` VARCHAR(64) NOT NULL,
...
DROP USER 'db_user'@'%';
CREATE USER 'db_user'@'%' IDENTIFIED BY 'Super_Secure_INFOSEC22_!?';
...
GRANT SELECT,INSERT,DELETE,UPDATE ON `INFOSEC_DB`.`reservation` TO 'db_user'@'%';
